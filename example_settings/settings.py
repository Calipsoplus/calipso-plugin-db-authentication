"""
Django settings for example_settings project.
...
SECRET_KEY = '+m$kvue9!pm#_!encb93dxep=*rev)=(i&&n%ae$so6n_rq2%+'
...
# fixtures
FIXTURE_DIRS = {
     os.path.join(BASE_DIR, 'cp_authentication', 'tests', 'fixtures')
}
